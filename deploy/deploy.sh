...
for f in web/index.html web/app.js web/renderer.js web/disasm.js web/style.css \
         ...
         web/tracer.html web/tracer.js web/die-centroids.js web/block-regions.js web/pins.js web/chain-cells.js web/clock-gen.js web/interrupt-paths.js web/solo-palette.js \
