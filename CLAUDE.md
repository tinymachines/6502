...
| | |
|---|---|
| Simulation | Complete. 121 tests, bit-exact against the original. |
...
cargo test --workspace --profile proof   # the verification build: same
                                    ...
                                    # 121 green either way. Benches and
                                    # anything shipped stay on --release,
                                    # whose published figures were measured
                                    # there.
cargo test --workspace              # 121 tests: netlist, functional, golden,
                                    ...
                                    # datapath + replay + state + knobs + bus), gpu (parity;
